...
# -*- coding: utf-8 -*-
#
# bidsutils documentation build configuration file, created by
# sphinx-quickstart
#
...
project = 'bidsutils'
copyright = '2020-' + datetime.today().strftime("%Y") + ', FIU-Neuro developers'
...
import bidsutils
version = bidsutils.__version__
# The full version, including alpha/beta/rc tags.
release = bidsutils.__version__
...
linkcode_resolve = make_linkcode_resolve('bidsutils',
                                         u'https://github.com/FIU-Neuro/'
                                         'bidsutils/blob/{revision}/'
